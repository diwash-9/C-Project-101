...
//        fprintf(file, "<p>Response: %d</p>\n", currentResponse);
     ...
     if (totalScore > 24 && totalScore < 48)
    {
        ...
        fprintf(file, "<p>Consult to a Doctor</p>\n");
        fprintf(file, "<h4>Some advice:</h4>\n");
        fprintf(file, "<ol>\n");
    ...
    else if (totalScore > 72 && totalScore < 96)
    {
        ...
        fprintf(file, "<li><br>Intensive therapy: Consider participating in intensive outpatient programs or residential treatment centers that offer focused and immersive OCD treatment.</li>\n<br>");
    ...
    else if (totalScore > 96)
    {
        ...
        fprintf(file, "<li><br>Consider hospitalization: In some cases, hospitalization might be necessary to ensure safety, provide intensive treatment, and stabilize symptoms.</li>\n<br>");
    ...
    else
    {
        ...
        fprintf(file, "<li><br>Practice self-care: Engage in activities that promote relaxation, stress reduction, and overall well-being.</li>\n<br>");
        fprintf(file, "<li>Develop healthy strategies to manage stress and anxiety, such as exercise, mindfulness, or hobbies.</li>\n<br>");
        fprintf(file, "</ol>\n");
    }

    fprintf(file, "<p><h4>**Note that these recommendations should be customized to fit each person's requirements and circumstances.<br>Based on a comprehensive evaluation, a licensed mental health professional can offer tailored recommendations and advice.**</h4></p>\n");
    fprintf(file, "</ul></ul></ul></ul>\n");
    fprintf(file, "<h4 style=\"text-align: center;\">Have a good day</h4>\n");
    fprintf(file, "</body>\n</html>");
