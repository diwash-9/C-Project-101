...
//        fprintf(file, "<p>Response: %d</p>\n", currentResponse);
    ...
    else if (totalScore > 72 && totalScore < 96)
    {
        ...
        fprintf(file, "<li>\nIntensive therapy: Consider participating in intensive outpatient programs or residential treatment centers that offer focused and immersive OCD treatment.</li>\n");
    ...
    else if (totalScore > 96)
    {
        ...
        fprintf(file, "<li>\nConsider hospitalization: In some cases, hospitalization might be necessary to ensure safety, provide intensive treatment, and stabilize symptoms.</li>\n");
    ...
    else
    {
        ...
        fprintf(file, "<li>\nPractice self-care: Engage in activities that promote relaxation, stress reduction, and overall well-being.</li>\n\n");
        fprintf(file, "<li>Develop healthy strategies to manage stress and anxiety, such as exercise, mindfulness, or hobbies.</li>\n\n");
        fprintf(file, "</ol>\n");
    }

    fprintf(file, "<p><h4>**Note that these recommendations should be customized to fit each person's requirements and circumstances.Based on a comprehensive evaluation, a licensed mental health professional can offer tailored recommendations and advice.**</h4></p>\n");
