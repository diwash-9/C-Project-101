...
if (totalScore > 24 && totalScore < 48)
	...
	printf("\n\n**Note that these recommendations should be customised to fit each person's requirements and circumstances. \nBased on a comprehensive evaluation, a licenced mental health professional can offer tailored recommendations and advice.\n");
fprintf(file,"Note : Note that these recommendations should be customised to fit each person's requirements and circumstances. \nBased on a comprehensive evaluation, a licenced mental health professional can offer tailored recommendations and advice.**\n");
    printf("\n\n\t\t\t\tHave a good day");
    fprintf(file,"\n\n\t\t\t\tHave a good day");
