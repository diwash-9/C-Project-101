...
int main()
{
    ...
    fprintf(file, "<p>48-72: Moderate Symptoms of OCD</p>\n");
    fprintf(file, "<p>72-96: Severe Symptoms of OCD</p>\n");
    fprintf(file, "<p>&gt;96: Extreme Symptoms of OCD</p>\n");
    ...
    fprintf(file, "<p>Have a good day</p>\n");
    fprintf(file, "</body>\n</html>");
